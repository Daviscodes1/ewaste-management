...
if($_SESSION['name'] == "" or $_SESSION['account'] != "Customer"){
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	          <li class="active">
                ...
                <li>
                    <a href="#change_account" data-toggle="modal" data-target="#change_account">Password</a>
                </li>
                <li>
          ...
          <a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Garbage management</a>
              <ul class="collapse list-unstyled" id="pageSubmenu">
				<li>
                    <a href="trash.php">Register trash</a>
                </li>
                <li>
                    <a href="payment.php">Manage</a>
                </li>
              </ul>
			  </li>
	        </ul>
